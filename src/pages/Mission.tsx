    ...
    <div className="max-w-4xl mx-auto px-4 py-12 space-y-16">
      ...
      <section className="space-y-6">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {[
            ...
            <Card key={f.title} className="border border-border/50 shadow-sm">
      ...
      <section className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Card className="border border-border/50 border-l-4 border-l-secondary shadow-sm">
          ...
          <Card className="border border-border/50 border-l-4 border-l-primary shadow-sm">
            <CardContent className="p-6 space-y-2">
